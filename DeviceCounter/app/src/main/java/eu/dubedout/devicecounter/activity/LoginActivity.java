...
public class LoginActivity extends AppCompatActivity implements LoginActivityViewable {
    ...
    @Bind(R.id.activity_login_username_wraper)  TextInputLayout activityLoginUsernameWraper;
    @Bind(R.id.activity_login_password)         EditText activityLoginPassword;
    @Bind(R.id.activity_login_password_wraper)  TextInputLayout activityLoginPasswordWraper;
